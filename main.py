...
def welcome(m):
    ...
    markup.add(a)
    b = types.InlineKeyboardButton("\xDA\xA9\xD8\xA7\xD9\x86\xD8\xA7\xD9\x84\x20\xD9\x85\xD8\xA7\x20\xF0\x9F\x93\xA2", url="https://telegram.me/TeleAgent_TEAM")
    markup.add(b)
    c = types.InlineKeyboardButton("Cloud Downloader",callback_data='about')
    markup.add(c)
