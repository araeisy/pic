...
def callback_inline(call):
    if call.message:
	        if call.data == "about":
            bot.answer_callback_query(callback_query_id=call.id, show_alert=True, text="Cloud Downloader is a simple Telegram bot in Python! this bot can download JPG , PNG & ZIP formats.")
